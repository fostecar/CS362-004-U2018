...
//creating method called adventurer which contains the logic for adventuerer called by cardEffect()
...
void playBaron(struct gameState *state, int choice1) {
	int currentPlayer = whoseTurn(state);
